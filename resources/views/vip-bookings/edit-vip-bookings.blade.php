@extends('Layout.main')
@section('title', 'Edit Popular Rituals')
        ...
        <div class="row">
            <div class="col-xl">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form
                            action="{{ route('edit-store-vip-bookings', ['vip_booking_id' => $vipbooking->vip_booking_id])}}"
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="text" class="form-control" id="title" name="title"
                                        ...
                                        aria-describedby="dharamshala-title-icon" value="{{ $vipbooking->title }}" />
                                </div>
                                @error('title')
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-merge speech-to-text">
                                    <textarea class="form-control" id="description" name="description"
                                        ...
                                        rows="2">{{ $vipbooking->description }}</textarea>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="hidden" name="hidden_image" value="{{ $vipbooking->image }}">

                                @if (!empty($vipbooking->image))
                                    <div class="mt-2">
                                        <img src="{{ asset($vipbooking->image) }}" alt="Image"
